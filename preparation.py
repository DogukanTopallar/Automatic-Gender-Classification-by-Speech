# -*- coding: utf-8 -*-
"""
Created on Tue Dec 13 01:16:16 2022
...
def extract_feature(file_name, **kwargs):
    """
    'file_name' ses dosyasından özellik çıkarımı
    ...
    """ 
    kwargs.get ile varsayılan değerler atanıyor.
    """
    X, sample_rate = librosa.core.load(file_name)
    """
    Ses dosyasını default sr ile yükler. default sr = 22050
    Ses dosyasını 22050 kez örnekler.
    """
